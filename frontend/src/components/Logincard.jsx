...
// #2626266b
const Logincard = () => {
    const {login,setlogin,name,setname,email,setemail,password,setpassword}=useContext(AppContext)
  ...
  return (
    ...
    <div className="flex justify-center border border-[#c10404ff] rounded-md bg-[#2626266b] p-4 gap-2 items-center">
            ...
            <path d="M3.125 13.125a4.375 4.375 0 0 1 8.75 0M10 4.375a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0" stroke="#6B7280" stroke-opacity=".6" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <input type="text" onChange={(e)=>setname(e.target.value)}  placeholder="Enter your Name" className="bg-transparent text-white placeholder-gray-500/80 outline-none text-sm w-full h-full" required />                 
                    </div>
                    <div className="flex mt-8 items-center w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
                    ...
                    <p className="text-[#f83838ff] text-sm mt-4">Don’t have an account? <a className="text-white hover:underline" href="#">Sign up</a></p>
                </form>
            </div>
    </div>

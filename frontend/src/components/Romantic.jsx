...
// import {romantic} from "../assets/data.json"
...
const Romantic = () => {
  ...
  const {list,setlist,setcurrfilm,login,userlist,setuserlist,Wishlistind,setWishlistind} = useContext(AppContext)
...
// console.log(list)
useEffect(()=>{
  fetch("http://localhost:3000/api/romantic")
...
async function addlist(item){
  ...
  return (
    <div className='relative my-8 mx-4'>
      <div className='text-2xl my-4'>Romantic Picks</div>

...
// import {series} from "../assets/data.json"
...
useEffect(()=>{
  ...
  return (
    <div className='relative my-8 mx-4'>
      <div className='text-2xl my-4'>Top Series</div>
...
//               <div className='p-4'>
//                 {Wishlistind.includes(item.id)?
//                 <button onClick={()=>navigate("/wishlist")} className='text-[18px] rounded-md bg-[#ff0000ff] px-3 py-1 w-[100%]'>
//                   Go to Wishlist
//                   </button>:
//                   <button onClick={()=>{setlist([...list,item.id]);setWishlistind([...Wishlistind,item.id])}} className='text-[18px] rounded-md bg-[#ff0000ff] px-3 py-1 w-[100%]'>
//                     Add to Wishlist
//                     </button>}
